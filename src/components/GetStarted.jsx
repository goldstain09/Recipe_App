    ...
    <div>
      <div className="container-fluid containr" id="and">
        ...
        <div id="note">
          ...
          >
            Please note that dietary preferences and restrictions can vary, so
            it's always important to consider individual needs when preparing or
            consuming these dishes.
            <div className="mt-2">
              <button
                type="button"

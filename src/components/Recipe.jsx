...
export default function Recipe() {
  ...
  return (
    <>
      ...
      {data ? (
        <div className="container mt-5 pt-3 main_Container">
          ...
          <div className="row pt-5">
            ...
            <div className="col col-12 col-lg-8">
              ...
              <p>
                Note* If you have any query to this recipe, feel free to ask by~
                mail
              </p>
          ...
          <div className="container">
            <div className="row mt-5">
              {/* ingridients */}
              <ul
                className="list-group col-12 col-lg-4 col-xl-4"
                style={{
                  borderRight: "1px solid #10abff",
                  borderRadius: "25px",
                }}
              >
                ...
                {Object.entries(data.data.recipe.ingridients)
                  ...
                  .map(([key, value]) => (
                    <li
                      className="ingrii list-group-item d-flex gap-2 justify-content-between align-items-center"
                      key={key}
                    >
              ...
              <ul className="list-group col-12 col-lg-7 col-xl-7">
                ...
                <div className="ms-2 me-auto">
                  {Object.entries(data.data.recipe.steps)
                    ...
                    .map(([key, value]) => (
                      <li
                        className="stepp list-group-item d-flex gap-2 justify-content-between align-items-center"
                        key={key}
                      >
            ...
            >
              <h3 style={{ color: "#8ad6ffd2" }} className="h3">
                Important Info:
              </h3>
              <div className="d-flex gap-4">
                <h6 className="text-secondary h5 pt-2">
                  IF it's your recipe you can Delete it...
                </h6>
                <h6 className="text-secondary h5 pt-2">
                  But you have to enter that KEY which we give you on the time
                  of adding...
                </h6>
                <button
                  type="button"
              ...
              <h5 className="text-primary h5">
                If you Forget it my Mistake... you can send an Delete Request
                Email by Email you use to add this recipe
              </h5>
              <h5 className="text-primary h5">
                We will check and delete it...
              </h5>
            </div>
          </div>

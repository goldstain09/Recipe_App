...
export default function NavBar() {
  ...
  return (
    <>
      <header>
        <div
          className="container-fluid d-grid gap-3 align-items-center main-container"
        ...
        >
            ...
            <div className="w-25">
              ...
              >
                <span
                  ...
                  style={{ fontSize: "4rem", color: "#8AD6FF" }}
                >
                  app_registration
                </span>
              </button>
          ...
          <div className="align-items-center form_div">
            <form
              className="w-100 me-1 d-flex gap-3 searchBAR_div"
              onSubmit={search}
            >
              <input
                type="search"
              ...
              <button type="submit" className=" btn btn-outline-success">
                <span
                  className="material-symbols-outlined pt-2"
                  style={{ fontSize: "3rem" }}
                >
                  menu_book
                </span>
            ...
            {inputValueError && (
              <p className="text-danger ms-1 ms-sm-2 ms-md-3 ms-lg-4 ms-xl-5 fs-5">
      ...
      <div
        ...
        style={{ backdropFilter: "blur(10px)", background: "" }}
        tabIndex="-1"
        id="offcanvasExample"
      ...
      >
        <div className="offcanvas-header">
          <h5
            ...
            style={{ color: "#46beff", fontFamily: "'Lobster', cursive" }}
          >
            Recipes...
          </h5>
          <button
        ...
        <div className="offcanvas-body">
          <div>
            ...
            <div className="align-items-center ">
              <form
                className="w-100 me-1 d-flex gap-3 offCanvas_search"
                onSubmit={search}
              >
                <input
                  type="search"

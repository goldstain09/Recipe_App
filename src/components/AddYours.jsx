...
export default function AddYours() {
    ...
    const iPersonalDetails = {
        username: '', useremail: '', recipename: '', category: '', image: '', description: ''
    }
    const iSteps = {}
    const iIngridients = {}
    ...
    // distructuring....
    const { username, useremail, recipename, category, description } = personalDetails;
    // const { } = steps;
    // const { } = ingridients;
    ...
    const [cantLeaveEmpty_Ingridients, setCantLeaveEmpty_Ingridients] = useState(false);
                                    ...
                                    if (description.length > 100) {
                                        if (ingridientsInputs.length > 4) {
                                            if (stepsInputs.length > 4) {
                                                ...
                                                let checkEmpty_S = values_S.filter((item) => item === '');
                                                if (checkEmpty_S.length <= 1) {
                                                    let values_I = [...ingridientsInputs];
                                                    let checkEmpty_I = values_I.filter((item) => item === '');
                                                    if (checkEmpty_I <= 1) {
                                                        ...
                                                        setPersonalDetails({ username: '', useremail: '', recipename: '', category: '' });
                                                        setStepsInputs(['']);
    ...
    if (adding_loading) {
        return (<div className='text-center' style={{ marginTop: '40vh', marginLeft: '48vw' }}>
            <Triangle
                height="80"
                width="80"
                color="grey"
            ...
            <div className='container-fluid py-5' style={{ background: '#8ad6ff42' }}>
                <form className='container' onSubmit={submit}>
                    <div className=' row d-flex '>
                        ...
                        {/*                                      EMAIL                                    */}
                        <div className="mb-3  col col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 " >
                            <label htmlFor="email" className="form-label">Your Email (it's for someone who like your recipe directly contact you for it...)</label>
                            <input
                                type="email"
                                name='useremail'
                                className="form-control"
                                ...
                                value={useremail}
                                onChange={inputChange_PD}
                                onInput={() => { setEmailError(false); setEmailValidateError(false) }} />
                            {
                                emailError && <p className='text-danger'>Please enter your e-mail...</p>
                            }
                            {
                                emailValidateError && <p className='text-danger'>Please enter a valid e-mail address...</p>
                            }
                        </div>
                        ...
                        <div className="mb-3 col col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 ">
                            ...
                            <input
                                ...
                                value={recipename}
                                onChange={inputChange_PD}
                                onInput={() => { setRecipeNameError(false) }} />
                            {
                                recipeNameError && <p className='text-danger'>Please enter your recipe name...</p>
                            }
                        </div>
                        ...
                        <div className="mb-3 col col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 ">
                            ...
                            <input
                                ...
                                value={category}
                                onChange={inputChange_PD}
                                onInput={() => { setCategoryError(false) }} />
                            {
                                categoryError && <p className='text-danger'>Please enter your Recipe Category...</p>
                            }
                        ...
                        {/*                                     IMAGE                                      */}
                        <div className="mb-3 col col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 ">
                            <label htmlFor="" className="form-label">Upload Preview Image</label>
                            <input
                                type="file"
                                className="form-control"
                                name='Image'
                                ...
                                onInput={() => { setImageError(false) }} />
                            {
                                imageError && <p className='text-danger'>Please Select an Image...</p>
                            }
                        </div>
                        {/*                                     DESCRIPTION                                    */}
                        <div className="mb-3  col col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 ">
                            ...
                            <textarea cols="10" rows="5"
                                ...
                                value={description}
                                onChange={inputChange_PD}
                                onInput={() => { setDes_Error(false) }} ></textarea>
                            {
                                des_Error && <p className='text-danger'>Please enter something about your dish...(min.30 words)</p>
                            }
                        </div>
                        ...
                        <div className="mb-3  col col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 ">
                            <label htmlFor="ingridients" className="form-label">Ingridients:</label>
                            {
                                ingridientsInputs.map((input, index) => (<div key={index}>
                            ...
                            {
                                minimumIngridientsError && <p className='text-danger'>You've to enter minimum 5 Ingridients</p>
                            }
                            {
                                cantLeaveEmpty_Ingridients && <p className='text-danger'>You can't leave more than one ingridients input field empty...</p>
                            }
                        ...
                        <div className="mb-3  col col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 ">
                            ...
                            {
                                stepsInputs.map((input, index) => (<div key={index}>
                            ...
                            {
                                minimumStepsError && <p className='text-danger'>You've to enter minimum 5 Steps</p>
                            }
                            {
                                cantLeaveEmpty_Steps && <p className='text-danger'>You can't leave more than one steps input field empty...</p>
                            }
                            <button onClick={(event) => {
                                event.preventDefault();
